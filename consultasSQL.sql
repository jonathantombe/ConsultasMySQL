...
INSERT INTO departamento VALUES(3, 'Recursos', 160000, 26000 );
INSERT INTO empleado(codigo, nif, nombre, apellido1, apellido2, codigo_departamento )values 
(1, 'aaaaaaaaa', 'Maria', 'Perez', 'Gomez', 1 ),
(2, 'bbbbbbbbb', 'Manuel', 'Muños', 'Enao', 2),
(3, 'ccccccccc', 'Santiago', 'Rodriguez', 'Gonzales', 3);
...
SELECT codigo, LEFT(nif, LENGTH(nif) - 1) AS nif_digitos, RIGHT(nif, 1) AS nif_letra FROM empleado;
